            ...
            <form action="{{ url('item/update/'.$item->id) }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" max="100" class="form-control" id="price" name="price" value="{{$item->price}}">
                        <div class="text-danger">
                            @if($errors->has('price'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" max="100" class="form-control" id="stock" name="stock" value="{{$item->stock}}">
                        <div class="text-danger">
                            @if($errors->has('stock'))
